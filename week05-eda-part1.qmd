...
5 categorical variables (\~6 if you account for logical)
...
Answer: It suggest the distribution is skewed to the right - a tail usually high values is pulling the mean up. The Median stays put because it only care about position, not magnitude.
...
Answer: Histograms are used for continuous data & bar chart can be used for categorical data
...
Yes, it do be matching my fat oval
